...
public class SortUtil {
     ...
     */
    public static void handlePageSort(PagedRequest request, Page page, String defaultSort, String defaultOrder, boolean camelToUnderscore) {
     ...
     * @param page    Page
     */
    public static void handlePageSort(PagedRequest request, Page page) {
     ...
     * @param camelToUnderscore 是否开启驼峰转下划线
     */
    public static void handlePageSort(PagedRequest request, Page page, boolean camelToUnderscore) {
     ...
     * @param camelToUnderscore 是否开启驼峰转下划线
     */
    public static void handleWrapperSort(PagedRequest request, QueryWrapper wrapper, String defaultSort, String defaultOrder, boolean camelToUnderscore) {
        String sortField = request.getSortField();
        if (camelToUnderscore) {
            sortField = WebUtil.camelToUnderscore(sortField);
            defaultSort = WebUtil.camelToUnderscore(defaultSort);
     ...
     * @param wrapper wrapper
     */
    public static void handleWrapperSort(PagedRequest request, QueryWrapper wrapper) {
     ...
     * @param camelToUnderscore 是否开启驼峰转下划线
     */
    public static void handleWrapperSort(PagedRequest request, QueryWrapper wrapper, boolean camelToUnderscore) {
